...
def main(args):
    ...
    LBO_data = sio.loadmat('./data/LBO_Darcy.mat')
    ...
    x_train = x_train.reshape(ntrain,num_node,1)
    x_test = x_test.reshape(ntest,num_node,1)
...
if __name__ == "__main__":
    ...
    for i in range(1): 
        ...
        for args in [
                        ...
                        'num_train': 1000, 
                        'num_test': 200,
                        'CaseName': 'Darcy_Unstruct_HFR/'+str(i),
                        'lr' : 0.001},
                    ]:
